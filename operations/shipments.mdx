---
title: "Shipment Manifests: Creating and Managing Freight"
...
<CardGroup cols={2}>
  <Card title="Search by ID or AWB" icon="magnifying-glass">
    Type any part of the manifest ID or AWB number in the search bar. Results filter as you type, with a 300 ms debounce to keep the interface smooth.
  </Card>
