...
description: "View, search, and manage all customer invoices — track outstanding balances, record payments, adjust fees, and download billing documents."
---
...
<Note>
  All payments — whether collected through the POS, recorded manually, or processed online — are listed in the **Payments** section at the bottom of the invoice detail page, showing the date, method, reference, and amount applied for each entry.
</Note>
