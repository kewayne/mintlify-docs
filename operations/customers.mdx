---
title: "Managing Customers in the Shiipp Backoffice"
...
<Steps>
  <Step title="Open the search bar">
    Click the **Search by name, email, phone, or code…** field at the top of the page. You can also press <kbd>Ctrl K</kbd> (Windows / Linux) or <kbd>⌘ K</kbd> (Mac) anywhere in the backoffice to open the global search bar, which searches across customers, packages, and invoices simultaneously.
  </Step>
