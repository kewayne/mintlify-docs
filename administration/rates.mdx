---
title: "Manage Shipping Rate Tables and Pricing Tiers"
sidebarTitle: "Rates"
description: "Create and manage shipping rate tables, define weight-based pricing tiers, import bulk CSV rates, and control which rate table is used for live shipment calculations."
---
...
<Steps>
  ...
  <Step title="Prepare your CSV file">
    Your file must have exactly two columns with no header row:

    ```
    Weight (lbs), Customer Price ($)
    1.0, 5.50
    2.0, 9.00
    3.0, 12.50
    ```
