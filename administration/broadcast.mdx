---
title: "Campaign Manager: Send Broadcasts to Customers"
sidebarTitle: "Broadcast"
description: "Compose and send email, WhatsApp, and push notification campaigns to targeted customer groups, individual recipients, or your entire verified customer base."
---
...
<CardGroup cols={3}>
  <Card title="Email" icon="envelope">
    Sends a fully formatted HTML email. Supports rich text, images, and personalisation variables. Open-rate tracking is available for email campaigns.
  </Card>
...
<Steps>
  ...
  <Step title="Write the email body">
    Use the rich text editor (powered by TinyMCE) to compose your message. The toolbar gives you access to headings, bold, italic, bullet lists, links, and images. To insert a personalisation variable, click **Insert Variable** in the toolbar and choose from the menu.
  </Step>
</Steps>
...
Fill in the **Notification Title** (shown in bold on the device), the **Notification Body** (keep it to one or two short sentences), and optionally a **Image URL** and a **Deep Link / Route** (e.g. `/dashboard`) that opens a specific screen in the app when the user taps the notification.
...
<Steps>
  ...
  <Step title="Review the preview">
    Scroll the Live Preview panel and confirm the subject, body copy, and personalisation look correct.
  </Step>
