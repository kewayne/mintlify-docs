---
title: "How to Log In to the Shiipp Backoffice"
sidebarTitle: "Logging In"
description: "Step-by-step guide to accessing the Shiipp agent portal, signing in with your staff credentials, handling two-factor authentication, and logging out securely."
---
...
Open your web browser and navigate to your organisation's backoffice URL. The login page is labelled **Agent Portal** and displays the "Sign in to workspace" heading along with your company logo. If you are already authenticated, the system automatically redirects you to the Operations Dashboard without requiring you to fill in the form again.
...
<Steps>
  <Step title="Enter your email address">
    Type the email address associated with your staff account into the **Email Address** field. Use the address your administrator set up for you — typically your work email.
  </Step>
  ...
  <Step title="Click Sign In to Dashboard">
    Click the **Sign In to Dashboard** button. The button shows a loading spinner while your credentials are being verified against the server.
  </Step>
  ...
  <Step title="Complete two-factor authentication (if required)">
    ...
    <Note>
      The code must be exactly 6 digits. If you need to use a different account, click **Change account** to return to the credentials step.
    </Note>
  </Step>

  <Step title="Wait for the redirect">
    On success, the button briefly turns green and displays "Success! Redirecting…". You are then taken directly to the Operations Dashboard.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Enter your admin email address">
    Type the email address registered to your staff account and click **Send Recovery Link**.
  </Step>
...
Your session token is stored in the browser's local storage. The dashboard continuously validates this token in the background. If your session expires or your account is deactivated, you are automatically redirected back to the login page and your stored token is cleared.
...
<Note>
  Logging out clears your session token, refresh token, and user profile data from the browser. Always log out when using a shared or public computer.
</Note>
